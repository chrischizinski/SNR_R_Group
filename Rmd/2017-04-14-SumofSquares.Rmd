...
- Simplest technique for the confrontatin between models and data is sum of squares
...
1. Input the data and generate a range of potental values for *A*, *B*, and *C*
